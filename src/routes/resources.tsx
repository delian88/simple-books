                ...
                <section className="bg-gray-50 py-20">
                    <div className="mx-auto max-w-4xl px-6">
                        ...
                        <div className="space-y-6 text-lg text-gray-700">
                            <p>
                                Ledgerly was born from a simple frustration: why is accounting software so complicated? As small business owners ourselves, we struggled with traditional accounting tools that required deep financial knowledge and hours of training.
                            </p>
                            <p>
                            ...
                            <p>
                                So we built Ledgerly—accounting software that speaks plain English, not accounting jargon. No debits and credits. No confusing journal entries. Just simple, straightforward bookkeeping that anyone can understand.
                            </p>
                            <p>
                                Today, Ledgerly serves thousands of small businesses worldwide, helping them stay on top of their finances without keeping an accountant on retainer.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="bg-emerald-600 py-20">
                    <div className="mx-auto max-w-4xl px-6 text-center">
                        ...
                        <Button asChild size="lg" variant="secondary">
                            <a href="mailto:hello@ledgerly.app">
