            ...
            <div className="pt-20">
                ...
                <section className="mx-auto max-w-7xl px-6 py-20 text-center">
                    ...
                    <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-600">
                        Mykobobooks combines powerful automation with intuitive design to make bookkeeping accessible for everyone.
                    </p>
                </section>
                ...
                <section className="mx-auto max-w-7xl px-6 py-20 text-center">
                    ...
                    <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-600">
                        Join thousands of small businesses using Mykobobooks to manage their books.
                    </p>
