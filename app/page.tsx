      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200 shadow-sm animate-in fade-in slide-in-from-top duration-700">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
          ...
          <nav className="hidden items-center gap-8 md:flex">
            <Link href="/features" className="group flex items-center gap-1 text-sm font-medium text-gray-700 transition-colors hover:text-gray-900">
              Features <ChevronDown className="h-4 w-4 transition-transform group-hover:translate-y-0.5" />
            </Link>
            <Link href="/how-it-works" className="text-sm font-medium text-gray-700 transition-colors hover:text-gray-900 hover:underline underline-offset-4">
              How it works
            </Link>
            <Link href="/pricing" className="text-sm font-medium text-gray-700 transition-colors hover:text-gray-900 hover:underline underline-offset-4">
              Pricing
            </Link>
            <Link href="/resources" className="group flex items-center gap-1 text-sm font-medium text-gray-700 transition-colors hover:text-gray-900">
              Resources <ChevronDown className="h-4 w-4 transition-transform group-hover:translate-y-0.5" />
            </Link>
            <Link href="/about" className="text-sm font-medium text-gray-700 transition-colors hover:text-gray-900 hover:underline underline-offset-4">
              About
            </Link>
          </nav>
              ...
              {user ? (
                ...
                <>
                  ...
                  <Button asChild variant="outline" className="w-full">
                    <Link href="/auth?mode=signin" onClick={() => setIsMobileMenuOpen(false)}>Sign in</Link>
                  </Button>
                </>
              )}
            </div>
