...
export default function ExpensesPage() {
  ...
  const doUpload = processReceiptBase64;
  const doVoice = processVoiceExpense;
  const doSave = saveAIExpense;
  const doDelete = deleteAIExpense;
  const fetchDocument = getExpenseDocument;
